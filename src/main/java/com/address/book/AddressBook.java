...
public class AddressBook {
    ...
    public void DefaultContact() {
        book.get(0).list.add(new Contact("Deep", "Saha", "ejipura", "bangalore","karnataka", "560047", "9916522077", "deepsaha9@gmail.com"));
        book.get(1).list.add(new Contact("Deep1", "Saha1", "mysureplace", "maysure","karnataka", "560070", "9916522077", "deepsaha69@gmail.com"));
        book.get(1).list.add(new Contact("Deep2", "Saha2", "boraservice", "guwahati", "Assam", "700012", "9916522077", "deepsaha39@gmail.com"));
        book.get(2).list.add(new Contact("Deep3", "saha3", "ejipura", "bangalore", "karnataka", "560047", "9916522077", "deepsaha288@gmail.com"));
    ...
    private void AddDetails() {
        ...
        int num = sc.nextInt();
        list.add(0, new Contact("Deep", "Saha", "ejipura", "bangalore", "karnataka", "560047", "9916522077", "deepsaha9@gmail.com"));
